...
glm::vec3 Position3 = glm::vec3(-0.605, 14.440, 24.366);
glm::vec3 Front3 = glm::vec3(0.009, -0.225, -0.974);
glm::vec3 Up3 = glm::vec3(0.002, 0.974, -0.225);
glm::vec3 Right3 = glm::vec3(1.000, -0.000, 0.009);
